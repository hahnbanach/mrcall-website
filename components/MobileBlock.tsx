        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] text-brand-black">
              Your office isn&apos;t a place.{' '}
              <span className="text-brand-blue">It&apos;s an app.</span>
            </h2>
            <p className="mt-6 text-lg leading-relaxed text-brand-black/60 max-w-lg">
              Take your business intelligence everywhere. Unlike competitors restricted to text,
              MrCall offers native iOS and Android apps. Talk directly to your agent — anywhere, anytime.
            </p>

            <div className="mt-8 space-y-4">
              {[
                'Native iOS & Android apps',
                'Voice-first interaction — just talk',
                'Full call history and transcriptions',
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[9px] uppercase tracking-wide opacity-70 leading-none">Download on the</div>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[9px] uppercase tracking-wide opacity-70 leading-none">Get it on</div>
