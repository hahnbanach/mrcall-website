...
4. Update `./docs/ARCHITECTURE.md` with what we have done in this session. Remember that `./docs/ARCHITECTURE.md` is not a log file: it must contain ONLY description of the architecture as is, without any reference to past implementation
